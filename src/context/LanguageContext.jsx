...
const translations = {
  en: {
    ...
    "scanner.url_btn": "Phone, Bank & URL Check",
    ...
    "scanner.url_label": "URL / Web Address (Optional)",
    "scanner.phone_label": "Sender Phone Number (Optional)",
    "scanner.bank_label": "Bank Account Number (Optional)",
    "scanner.searching": "Searching database...",
    "scanner.scan_url_btn": "Scan URL & Contact",
    "scanner.scan_target_btn": "Scan & Analyze",
    "scanner.empty_url_error": "Please enter a website address.",
    "scanner.empty_target_error": "Please enter at least a website address, phone number, or bank account number.",
    ...
    "scanner.bank_placeholder": "e.g. 1234567890 (Maybank, CIMB, etc.)",
  ...
  ms: {
    ...
    "scanner.url_btn": "Semak Telefon, Bank & URL",
    ...
    "scanner.url_label": "URL / Alamat Web (Pilihan)",
    "scanner.phone_label": "Nombor Telefon Penghantar (Pilihan)",
    "scanner.bank_label": "Nombor Akaun Bank (Pilihan)",
    "scanner.searching": "Mencari pangkalan data...",
    "scanner.scan_url_btn": "Imbas URL & Kenalan",
    "scanner.scan_target_btn": "Imbas & Analisis",
    "scanner.empty_url_error": "Sila masukkan alamat laman web.",
    "scanner.empty_target_error": "Sila masukkan sekurang-kurangnya alamat laman web, nombor telefon, atau nombor akaun bank.",
    ...
    "scanner.bank_placeholder": "cth. 1234567890 (Maybank, CIMB, dll.)",
